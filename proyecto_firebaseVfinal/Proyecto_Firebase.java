...
public class Proyecto_Firebase {
 ...
 /* // ==================== CREACIÓN DE UN TELÉFONO ====================
        Telefono smartphone = new Telefono(
                2001, // ID
                "iPhone 15 Pro", // Nombre
                999.99, // Precio
                10, // Stock
                "Apple", // Marca
                "A2848", // Modelo
                1.0, // Garantía (años)
                256, // Almacenamiento GB
                8, // RAM GB
                "iOS 17", // Sistema operativo
                "6.1 pulgadas" // Tamaño pantalla
        );

        // ==================== DEMOSTRACIÓN DE FUNCIONALIDADES ====================
        System.out.println("=== INFORMACIÓN COMPLETA DEL TELÉFONO ===\n");
        ...
        System.out.println("Categoría: " + smartphone.getTipoCategoria());
        System.out.println("Segmento: " + smartphone.getSegmento());
        System.out.println("¿Compatible con 5G?: " + (smartphone.esCompatibile5G() ? "Sí" : "No"));
        System.out.println("Precio con IVA: $" + smartphone.calcularPercioIVa());
        System.out.println("Relación calidad-precio: " + smartphone.getRelacionCalidadPrecio());
        System.out.println("¿Ideal para gaming?: " + (smartphone.esParaGaming() ? "Sí" : "No"));
        System.out.println("¿Adecuado para empresa?: " + (smartphone.esEmpresarial() ? "Sí" : "No"));
        System.out.println("¿Disponible para venta?: " + (smartphone.estaDisponibleParaVenta() ? "Sí" : "No"));
        System.out.println("Especificaciones técnicas: " + smartphone.getEspecificacionesTecnicas());
        System.out.println("Información completa: " + smartphone.getInfoCompletaTelefono());
...
//---------------------Metodos de Registro Herramienta
